...
static ngx_conf_post_handler_pt ngx_http_webapp_p = ngx_http_webapp;
...
static ngx_command_t ngx_http_hello_commands[] = {
	...
	offsetof(ngx_http_webapp_loc_conf_t, name),
	&ngx_http_webapp_p },
...
*/
static char *
	ngx_http_webapp(ngx_conf_t *cf, void *post, void *data)
{
